...
M.mod_scorm.init = function(Y, nav_display, navposition_left, navposition_top, hide_toc, collapsetocwinsize, toc_title, window_name, launch_sco, scoes_nav) {
    ...
    var scorm_toc_toggle_btn_hide = true; // ukrycie przycisku listy/menu ze scorm
    ...
    if(scorm_toc_toggle_btn_hide){
        document.getElementById('scorm_toc_toggle_btn').hidden = true;
    }
};

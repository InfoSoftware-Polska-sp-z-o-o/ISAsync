...
$string['activityoverview'] = 'You have upcoming iS-Sync sessions';
...
$string['bigbluebuttonbn:addinstance'] = 'Add a new iS-Sync room';
$string['bigbluebuttonbn:join'] = 'Join a iS-Sync room';
$string['bigbluebuttonbn:view'] = 'View iS-Sync room';
...
$string['indicator:cognitivedepth'] = 'iS-Sync cognitive';
$string['indicator:cognitivedepth_help'] = 'This indicator is based on the cognitive depth reached by the student in a iS-Sync activity.';
$string['indicator:socialbreadth'] = 'iS-Sync social';
$string['indicator:socialbreadth_help'] = 'This indicator is based on the social breadth reached by the student in a iS-Sync activity.';
$string['modulename'] = 'iS-Sync';
$string['modulenameplural'] = 'iS-Sync';
$string['modulename_help'] = 'iS-Sync is an open-source web conferencing system designed for online learning, which supports real-time sharing of audio, video, chat, slides, screen sharing, a multi-user whiteboard, breakout rooms, polling and emojis.

Using iS-Sync you can create a room for sessions such as live online classes, virtual office hours or group collaboration with remote students. The session can be recorded for later playback.';
$string['modulename_link'] = 'BigBlueButton/view';
$string['nosuchinstance'] = 'No such instance {$a->entity} with ID {$a->id}';
$string['pluginadministration'] = 'iS-Sync administration';
$string['pluginname'] = 'iS-Sync';
...
$string['search:activity'] = 'iS-Sync - activity information';
$string['search:tags'] = 'iS-Sync - tags information';
$string['settings'] = 'iS-Sync settings';
$string['privacy:metadata:bigbluebuttonbn'] = 'iS-Sync session configuration';
$string['privacy:metadata:bigbluebuttonbn:participants'] = 'A list of rules that define the role users will have in the iS-Sync session. A user ID may be stored as permissions can be granted per role or per user.';
...
$string['privacy:metadata:bigbluebutton'] = 'In order to create and join iS-Sync sessions, user data needs to be exchanged with the server.';
$string['privacy:metadata:bigbluebutton:userid'] = 'The user ID of the user accessing the iS-Sync server.';
$string['privacy:metadata:bigbluebutton:fullname'] = 'The full name of the user accessing the iS-Sync server.';
...
$string['config_server_url'] = 'iS-Sync server URL';
$string['config_server_url_description'] = 'restrictions as follows:
<ol>
...
$string['config_shared_secret'] = 'iS-Sync shared secret';
$string['config_shared_secret_description'] = 'The security secret of your iS-Sync server. The default secret is for a free iS-Sync service provided by Blindside Networks.';
...
$string['config_recording_default_description'] = 'Should the setting \'Session can be recorded\' be enabled by default when adding a new iS-Sync room?';
$string['config_recording_editable'] = 'Session can be recorded editable';
$string['config_recording_editable_description'] = 'Should \'Session can be recorded\' be editable in the iS-Sync activity settings?';
...
$string['config_recording_all_from_start_default_description'] = 'Should the setting \'Start recording from the beginning\' be enabled by default when adding a new iS-Sync room?';
$string['config_recording_all_from_start_editable'] = 'Start recording from the beginning editable';
$string['config_recording_all_from_start_editable_description'] = 'Should \'Start recording from the beginning\' be editable in the iS-Sync activity settings?';
...
$string['config_recording_hide_button_editable_description'] = 'Should \'Hide recording button\' be editable in the iS-Sync activity settings?';
$string['config_recording_refresh_period'] = 'Recording refresh period (in seconds)';
$string['config_recording_refresh_period_description'] = 'How often should the iS-Sync server be queried to refresh remote information for a recording?';
...
$string['config_waitformoderator_default_description'] = 'Should the setting \'Wait for moderator\' be enabled by default when adding a new iS-Sync room?';
$string['config_waitformoderator_editable'] = 'Wait for moderator editable';
$string['config_waitformoderator_editable_description'] = 'Should \'Wait for moderator\' be editable in the iS-Sync activity settings?';
...
$string['config_extended_capabilities_description'] = 'Configuration for extended capabilities when the iS-Sync server offers them.';
$string['config_uidelegation_enabled'] = 'UI delegation is enabled';
$string['config_uidelegation_enabled_description'] = 'These settings enable or disable the UI delegation to the iS-Sync server.';
$string['config_recordingready_enabled'] = 'Send recording available notification';
$string['config_recordingready_enabled_description'] = 'If enabled, a notification will be sent when a recording link is available. This feature requires the script post_publish_recording_ready_callback to be enabled on the iS-Sync server.';
$string['config_meetingevents_enabled'] = 'Register live sessions';
$string['config_meetingevents_enabled_description'] = 'If enabled, live sessions will be processed after the session ends. This feature is required for Activity completion and will only work if the iS-Sync server is capable of processing post_events scripts.';
...
$string['config_warning_bigbluebuttonbn_cfg_deprecated'] = 'iS-Sync makes use of config.php with a global variable that has been deprecated. Please convert the file as it will not be supported in future versions.';
...
$string['config_welcome_default_description'] = 'The welcome message is displayed when participants enter the room. If the field is left blank, then a message set on the iS-Sync server is displayed.';
...
$string['general_error_unable_connect'] = 'Unable to connect. Please check the url of the iS-Sync server AND check to see if the iS-Sync server is running.
Details : {$a}';
$string['general_error_no_answer'] = 'Empty response. Please check the url of the iS-Sync server AND check to see if the iS-Sync server is running.';
...
$string['index_error_unable_display'] = 'Unable to display the sessions. Please check the url of the iS-Sync server AND check to see if the iS-Sync server is running.';
...
$string['index_heading'] = 'iS-Sync rooms';
...
$string['mod_form_field_voicebridge_help'] = 'A number between 1 and 9999 that participants enter to join the voice session when using dial-in. If the value is 0 then the static voice bridge number will be ignored and a random number will be generated by iS-Sync. A number 7 will prefix the four digits typed.';
...
$string['view_error_unable_join_student'] = 'Unable to connect to the iS-Sync server.';
$string['view_error_unable_join_teacher'] = 'Unable to connect to the iS-Sync server. Please contact an administrator.';
$string['view_error_unable_join'] = 'Unable to enter the room. Please check the URL of the iS-Sync server AND check to see if the iS-Sync server is running.';
$string['view_error_bigbluebutton'] = 'iS-Sync responded with errors. {$a}';
$string['view_error_create'] = 'The iS-Sync server responded with an error message. The room could not be created.';
...
$string['view_noguests'] = 'The iS-Sync room is not open to guests.';
...
$string['view_message_recordings_disabled'] = 'Recordings are disabled on the server. iS-Sync activities of type \'Recordings only\' cannot be used.';
...
$string['view_recording_publish_link_deleted'] = 'This link cannot be republished because the original recording does not exist on the iS-Sync server. The link should be removed.';
...
$string['view_recording_unprotect_link_deleted'] = 'This link cannot be unprotected because the original recording does not exist on the iS-Sync server. The link should be removed.';
...
$string['messageprovider:instance_updated'] = 'iS-Sync session updated';
$string['messageprovider:recording_ready'] = 'iS-Sync recording available';
$string['new_bigblubuttonbn_activities'] = 'iS-Sync activity';
$string['notification_instance_created_intro'] = 'The <a href="{$a->link}">{$a->name}</a> iS-Sync room has been created.';
$string['notification_instance_created_small'] = 'A new iS-Sync room named {$a->name} was created.';
$string['notification_instance_created_subject'] = 'A new iS-Sync room has been created';
...
$string['notification_instance_updated_intro'] = 'The <a href="{$a->link}">{$a->name}</a> iS-Sync room has been updated.';
$string['notification_instance_updated_small'] = 'The {$a->name} iS-Sync session was updated';
$string['notification_instance_updated_subject'] = 'Your iS-Sync room has been updated';
$string['notification_recording_ready_small'] = 'A recording is available for the iS-Sync room {$a->name}.';
$string['notification_recording_ready_html'] = 'A recording is now available for the session in the iS-Sync room <a href="{$a->link}">{$a->name}</a>.';
$string['notification_recording_ready_plain'] = 'A recording is now available for the session in the iS-Sync room {$a->name}. Go to {$a->link} to access the recording link.';
...
$string['view_error_current_state_not_found'] = 'Current state was not found. The recording may have been deleted or the iS-Sync server is not compatible with the action performed.';
$string['view_error_action_not_completed'] = 'Action could not be completed';
$string['view_warning_default_server'] = 'restrictions as follows:
<ol>
<li>The maximum length for each session is 60 minutes</li>
<li>The maximum number of concurrent users per session is 25</li>
<li>Recordings expire after seven (7) days and are not downloadable</li>
...
$string['index_error_noinstances'] = 'There are no instances of iS-Sync rooms';
$string['index_error_bbtn'] = 'iS-Sync ID {$a} is incorrect';

...
/**
 * Strings for component 'access', language 'pl', version '4.0'.
 *
 * @package     access
 * @category    string
...
$string['breadcrumb'] = 'Pasek nawigacyjny';
$string['eventcontextlocked'] = 'Kontekst zablokowany';
$string['eventcontextunlocked'] = 'Kontekst odblokowany';
$string['hideblocka'] = 'Ukryj blok {$a}';
$string['showblocka'] = 'Pokaż blok {$a}';
$string['sitemap'] = 'Mapa strony';
$string['skipa'] = 'Pomiń {$a}';
$string['skipblock'] = 'Pomiń blok';
$string['skipnavigation'] = 'Pomiń nawigację';
$string['skipto'] = 'Pomiń i przejdź do {$a}';

...
/**
 * Strings for component 'enrol_signup', language 'pl', version '4.0'.
 *
...
$string['signup:unenrol'] = 'Wypisz użytkowników z kursu';
$string['signup:unenrolself'] = 'Wypisz się z kursu';

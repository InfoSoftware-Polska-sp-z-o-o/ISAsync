...
/**
 * Strings for component 'editor_tinymce', language 'pl', version '4.0'.
 *
...
$string['common:clipboard_msg'] = 'Akcje Kopiuj/Wytnij/Wklej nie są dostępne w Mozilli i Firefox.
...
$string['media_dlg:qt_stream_warn'] = 'Streamed rtsp resources should be added to the QT Src field under the advanced tab. You should also add a non streamed version to the Src field..';

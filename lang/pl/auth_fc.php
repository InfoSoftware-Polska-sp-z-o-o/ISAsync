...
/**
 * Strings for component 'auth_fc', language 'pl', version '4.0'.
 *
 * @package     auth_fc
 * @category    string
...
$string['auth_fcconnfail'] = 'Nieudanie połączenie. Numer  błędu: {$a->no}, Opis błędu: {$a->str}';
...
$string['auth_fccreators_key'] = 'Twórcy';
...
$string['auth_fcpasswd_key'] = 'Hasło';
...
$string['pluginname'] = 'Używaj serwera FirstClass';
